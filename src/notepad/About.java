...
public class About extends JFrame implements ActionListener{
    ...
    About(){
        ...
        JLabel l3 = new JLabel("<html>Yogesh Gautam<br>Notepad Version 2020<br>2020All rights reserved<br><br>Notepad is a word processing program, <br>Which allows changing of text in a computer file.<br>Notepad is a simple text editor for basic text-editing program<br> Which enables computer users to create documents. </html>");
